...
public class ContactCreationTests {
  ...
  public void testContactCreation() throws Exception {
    gotoAddnewPage();
    fillContactForm("Иван", "Михайлович", "Меркулов", "Mercury", "ADT Inc.", "Россия, г. Москва, ул. Аргуновская 35", "84957757575", "89262881045", "+74951231212", "ivanmercury@yandex.ru", "ivanmercury@gmail.com", "1989");
    initContactCreation();
    returnToHomePage();
    logout();
  }
  ...
  private void fillContactForm(String firstname, String middlename, String lastname, String nickname, String company, String address, String homephone, String mobilephone, String workphone, String email1, String email2, String birthdayyear) {
